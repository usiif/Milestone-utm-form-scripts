<div id="zf_div_tzljr5-EEhpbH-g0ljjPfpMfBERNR2v7JQ7xZj7LFXA"></div>
...
(function() {
  try {
    ...
    f.src = 'https://forms.zohopublic.com/sejalnagjee/form/ThinkingofaVillaMakeover/formperma/tzljr5-EEhpbH-g0ljjPfpMfBERNR2v7JQ7xZj7LFXA?zf_rszfm=1' + getUTMParams();
    f.style.border = "none";
    f.style.height = "553px";
    f.style.width = "90%";
    f.style.transition = "all 0.5s ease";
    f.setAttribute("aria-label", 'Claim Your Free Personalized Consultation');
    f.setAttribute("allow", "geolocation;");
    f.setAttribute("loading", "lazy");

    var d = document.getElementById("zf_div_tzljr5-EEhpbH-g0ljjPfpMfBERNR2v7JQ7xZj7LFXA");
    d.appendChild(f);
